...
namespace PartyGDK.Base.UI
{
    public class Scoreboard : MonoBehaviour
    {
        ...
        [SerializeField] private BaseAnimationHelper _animationHelper;
        ...
        private readonly Dictionary<PlayerCard, Transform> _cardsLerpTargets = new();
        ...
        private void Awake()
        {
            ...
            if (_animationHelper == null)
                _animationHelper = GetComponentInChildren<BaseAnimationHelper>();
        ...
        public void Show() { gameObject.SetActive(true); _animationHelper.Show(); }
        public void Hide() => _animationHelper.Hide(() => gameObject.SetActive(false));
    }
}
