...
using TMPro;
using PartyGDK.Base.Utils;
using PartyGDK.Base.Extensions;
...
namespace PartyGDK.Base.UI
{
    public class PlayerCard : MonoBehaviour
    {
        ...
        public void UpdatePlayerData()
        {
            ...
            if (_avatarImage != null)
            {
                _avatarImage.color = avatarColor.PreserveAlphaIfZero(_avatarImage.color);
                _avatarImage.sprite = Player.Avatar;
            }

            if (_nameText != null)
            {
                _nameText.color = nameColor.PreserveAlphaIfZero(_nameText.color);
